...
class TeamProfile {
    ...
    initialize(){this.managerQuestions()}
    ...
    //     this.Engineers[i] = new Engineer(arr[i].name, arr[i].id, arr[i].email, arr[i].github)
    //     }
    ...
    //     for(var i = 0; i < arr.length; i++) {
    //     this.Interns[i] = new Intern(arr[i].name, arr[i].id, arr[i].email, arr[i].school)
    //     }
